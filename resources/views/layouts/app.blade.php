            ...
            <div class="font-sf">
                <div class="container p-4 mx-auto" @click.outside="openMenu = null">
                    ...
                    <div class="flex items-center justify-between pt-4 space-x-4" aria-label="Global">
                        ...
                        <div class="hidden lg:flex space-x-1 items-center text-base xl:text-xl font-sf">
                        @foreach($menu as $item)
                        @if(count($item->children)>0)
                            <div class="relative">
                                <button @mouseenter="openMenu === {{ $item->id }} ? openMenu = null : openMenu = {{ $item->id }}" @mouseleave="openMenu = null" type="button" class="flex items-center justify-between cursor-pointer w-full border-b border-white text-left px-4" aria-expanded="false">
                                    ...
                                    <ul class="list-none">
                                            ...
                                            <li class="mb-2" x-data="{ expanded: false }">
                                                <button id="faqs-title-{{$child_item->id}}" type="button"
                                                    class="flex items-center justify-between w-full hover:bg-secondary cursor-pointer hover:text-white hover:rounded-3xl px-4 py-2 text-left"
                        ...
                        <x-button-primary>
                            <a href="https://sms.ast.nis.edu.kz/" target="_blank">
                                Жұмысшылар үшін
                            </a>
                        </x-button-primary>
